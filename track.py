...
TOTAL_MESSAGES_SENT = 0  # Initialize global message counter

# Discord Webhook URL (replace with your actual webhook URL)
DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1242747045861789697/nvsCzXlBzYBwx0B029YHEw7VdKcGaBmOYFIGQjzoKPKSv_8g-xoAHW3QtUJAM-OrW30g"
...
def save_data(users, all_conversations):
    ...
    try:
        with open(DATA_FILE, "w") as file:
            json.dump({"users": users, "conversations": all_conversations, "total_messages": TOTAL_MESSAGES_SENT}, file)
    except IOError as e:
        ...
        try:
            with open(DATA_FILE, "r") as file:
                ...
                if isinstance(data, dict):
                    TOTAL_MESSAGES_SENT = data.get("total_messages", 0)
...
def main_ui():
    ...
    if st.session_state.username is None:
        ...
        with st.sidebar:
            ...
            st.markdown(f'<a href="https://ko-fi.com/wwize" style="color:#ffffff;font-size:15px;font-family:monospace;">Support Me</a>', unsafe_allow_html=True)
            st.markdown(f'<a href="https://discord.com/invite/ZpvhS6aGGw" style="color:#ffffff;font-size:15px;font-family:monospace;">Discord</a>', unsafe_allow_html=True)
        ...
        if st.session_state.is_processing:
            ...
            # Increment global message counter and send to Discord
            TOTAL_MESSAGES_SENT += 1
            send_to_discord(f"Total messages sent to Lumiere: {TOTAL_MESSAGES_SENT}")
